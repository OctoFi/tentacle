...
contract BinaryOptions {
    ...
    Option[] array;
    constructor() public {
        tentacle = TentacleInterface(0x8316B082621CFedAB95bf4a44a1d4B64a6ffc336);
    }
    // direction : 1 = long, 0 = short
    function createOption(uint8 _direction) public payable {
        uint256 strikePrice = tentacle.getExchangeRate(
            "BTC",
            "USDC",
            "DEFAULT",
            10000
    ...
    function settleOptions() public {
        ...
        for (uint256 i = 0; i < 5; i++) {
            while (j < array.length) {
                ...
                uint256 currentPrice = tentacle.getExchangeRate(
                    "BTC",
                    "USDC",
                    "DEFAULT",
                    10000
