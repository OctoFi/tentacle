...
contract Floater{
    ...
    string public eventDescription = "This is an example project that is due 60 days from the date set. Alledgedly, the owner can refund all bets as well as resolution can be set when the time is up via Tentacle";
    ...
    function resolveEvent() external returns(bool){
        ...
        string memory result = tentacle.getEventResult("floater.market", toString(this));
