...
//test contract concept for leveraged positions of a token built-into an erc-20, with long/short capability... pegged to an external asset.
  ...
  function add(uint256 a, uint256 b) internal constant returns (uint256) {
    ...
    contract PegToken {
        ...
        function burnTokens(uint256 amount){
             ...
             uint256 amountDaiSend = tentacle.getExchangeRate("BABA", "USD", "PROVIDER1", 1).mul(amount).div(100);
        ...
        function buyLong (uint256 multiple) payable returns(bool){
            ...
            uint256 assetPrice = tentacle.getExchangeRate("BABA", "USD", "PROVIDER1", 1);
        ...
        function closePosition() returns(bool){
            ...
            uint256 currentPrice= tentacle.getExchangeRate("BABA", "USD", "PROVIDER1", 1);
        ...
        function getETH2TokenRate() constant returns(uint256){
            ...
            uint256 equityRate = tentacle.getExchangeRate("BABA", "USD", "PROVIDER1", 1);
            uint256 dolToEthRate = tentacle.getExchangeRate("DAI", "ETH", "DEFAULT", equityRate);
