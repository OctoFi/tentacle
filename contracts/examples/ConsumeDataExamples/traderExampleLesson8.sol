...
contract Trader{
   ...
   require(token.transfer(destAddress, destAmount));
    ...
    function getKyberSellPrice() constant returns (uint256){
       uint256 currentPrice =  tentacle.getExchangeRate("ETH", "DAI", "SELL-KYBER-EXCHANGE", 1000000000000000000);
        return currentPrice;
    }


     function getUniswapBuyPrice() constant returns (uint256){
       uint256 currentPrice =  tentacle.getExchangeRate("ETH", "DAI", "BUY-UNISWAP-EXCHANGE", 1000000000000000000);
        return currentPrice;
    }
