...
contract randomregisteredoracleExample {
    ...
    function getPriceFromOracle(string fromParam, string toParam, string venue, uint256 amount) public constant returns (uint256){
        ...
        uint256 rate1 = tentacle.getExchangeRate("MKR", "DAI", "DEFAULT", 1);
        uint256 rate2 = tentacle.getExchangeRate("ETH", "DAI", "DEFAULT", 100000000000000);
        uint256 rate3 = tentacle.getExchangeRate("WBTC", "ETH", "DEFAULT", 100000);
