//Legacy contract to support the Sell-Uniswap-Exchange functionality from earlier tutorials
//0x0a69cfd87edec895a5a77c4992e06c620bb48c44
...
contract IUniswapExchange {
    ...
    function getPriceFromOracle(string fromParam, string toParam, string  side, uint256 amount) public constant returns (uint256){  
        ...
        address sellToken = tentacle.getTokenAddress(fromParam);
        address buyToken = tentacle.getTokenAddress(toParam);
