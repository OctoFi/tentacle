...
contract flashIt{
    ...
    ERC20 theToken = ERC20(_reserve);
        ...
        //approve the token you are starting  (tokenOrder element 0 below)with (so that the tentacle contract perform its operations below )
        ...
        tentacle.arb(this, this, tokenOrder, _amount, exchangeOrder);
